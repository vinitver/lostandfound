...
function ItemPage(props) {
          ...
          <div className="itemDescription">
            ...
            {current_user === "true" ? (
              <div className="ed-button">
                <Button variant="danger" className="d-flex justify-content-center" onClick={handleShowDelete}>
                  Delete item
                </Button>
  ...
  const handleEdit = () => {
    ...
    Axios({
      ...
      .then((res) => {
        console.log(res);
        console.log("Item edited✏️ successfully!", {
          appearance: "success",
        });
        setTimeout(() => {
          window.location.reload();
          ...
          <Modal.Body>
            <Form>
              ...
              <Form.Group>
                ...
                <Form.Control
                  as="textarea"
                  placeholder="Enter Description and place where item is found"
                  value={description}
